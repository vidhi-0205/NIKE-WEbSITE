...
const SecondPage = () => {
  return (
    <div className="second-page relative min-h-screen flex items-center justify-between px-16 text-white"> 
    <div className="relative text-left m-3 tech">
        ...
        <span>
            <div className='text-[2rem] text-[#7fff00] stat-box'>42%</div>
            <div className='text-[1.5rem] text-[#BFC6C4]'>Energy Return</div>
        </span>
        <span>
            <div className='text-[2rem] text-[#7fff00] stat-box'>180G</div>
            <div className='text-[1.5rem] text-[#BFC6C4]'>ULTRALIGHT</div>
        </span>
        <span>
            <div className='text-[2rem] text-[#7fff00] stat-box'>∞</div>
            <div className='text-[1.5rem] text-[#BFC6C4]'>DURABILITY</div>
        </span>
        </div>
    </div>
    <img src={sneaker} alt="" className='h-[40%] w-[40%] drop-shadow-[0_0_200px_#7fff00] sneaker-img ' />
    </div>
  )
}
