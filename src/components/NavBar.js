...
const NavBar = () => {
  return (
    <nav className='navbar bg-black flex flex-direction-row justify-around items-center fixed top-0 left-0 w-full z-50 '>
        ...
        <div className='text-[#BFC6C495] flex justify-between gap-8 p-4 pb-5  font-bebas text-2xl tracking-wider font-thin'>
        ...
        <button className='text-[#7FFF00] font-bebas text-2xl tracking-wider font-thin hover:text-white '>SIGN UP</button>
    </nav>
  )
}
